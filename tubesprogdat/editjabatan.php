...
$query = "SELECT * FROM jabatan WHERE kd_jabatan = '$kd_jabatan'";
...
<body>
    ...
    <div class="container">
        <h1>Edit Jabatan</h1>
            <div class="pegawai">
                <form method="post" action="proseseditjabatan.php?id=<?php echo $jabatan['kd_jabatan']; ?>">
                <div>
                    <input type="hidden" id="kd_jabatan" name="kd_jabatan" value="<?php echo $jabatan['kd_jabatan']; ?>" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="gaji" name="gaji" value="<?php echo $jabatan['gaji']; ?>" required>
                </div>
                <div>
                    <label for="tunjangan">Tunjangan:</label>
                    <input type="text" id="tunjangan" name="tunjangan" value="<?php echo $jabatan['tunjangan']; ?>" required>
                </div>
