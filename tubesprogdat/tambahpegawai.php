        ...
        <h1>Profil Pegawai</h1>
            <div class="pegawai">
                ...
                <div>
                    ...
                    <input type="text" id="nama_pegawai" name="nama_pegawai" placeholder="Nama Pegawai" required>
                </div>
                <div>
                    <label>Tanggal Lahir:</label>
                    <input type="date" id="ttl" name="ttl" placeholder="Tanggal Lahir" required>
                </div>
                <div>
                    <label>Jenis Kelamin:</label>
                    <input type="text" id="jenis_kelamin" name="jenis_kelamin" placeholder="Jenis Kelamin L/P" required>
                </div>
                <div>
                    <label>Alamat:</label>
