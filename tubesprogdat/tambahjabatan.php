...
<body>
    ...
    <div class="container">
        <h1>Jabatan Pegawai</h1>
            <div class="pegawai">
                <form method="post" action="prosestambahjabatan.php">
                <div>
                    <label>Kode Jabatan:</label>
                    <input type="text" id="kd_jabatan" name="kd_jabatan" placeholder="Kode Jabatan" required>
                </div>
                <div>
                    <label>Nama Jabatan:</label>
                    <input type="text" id="nama_jabatan" name="nama_jabatan" placeholder="Nama Jabatan " required>
                </div>
                <div>
                    <label>Gaji:</label>
                    <input type="text" id="gaji" name="gaji" placeholder="Gaji" required>
                </div>
                <div>
                    <label>Tunjangan:</label>
                    <input type="text" id="tunjangan" name="tunjangan" placeholder="Tunjangan" required>
                </div>
